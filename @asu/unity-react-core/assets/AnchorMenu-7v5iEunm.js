import{j as o}from"./jsx-runtime-Dtp4yoXy.js";import{c as w}from"./index-DqAnBlJf.js";import{P as i}from"./index-DamiE3XO.js";import{r as d}from"./index-iql2cimc.js";import{q as N}from"./html-utils-C9gsfPJL.js";import"./googleAnalytics-4Pcl4n6_.js";import{B as R}from"./Button-DOBqzlQn.js";import{G as T}from"./GaEventWrapper-BygyXjtG.js";import{q as L}from"./styled-components.browser.esm-Cua4idQ2.js";function P(t){const[a,p]=d.useState(!1);return d.useEffect(()=>{const r=window.matchMedia(t);r.matches!==a&&p(r.matches);const l=()=>{p(r.matches)};return r.addEventListener("change",l),()=>r.removeEventListener("change",l)},[a,t]),a}let y=!1;const F=(t,a)=>{y||(y=!0,setTimeout(()=>{t(),y=!1},a))};let k;const O=(t,a)=>{window.clearTimeout(k),k=window.setTimeout(t,a)},D=L.div`
  &.sticky {
    position: fixed;
    top: 0;
    left: 0;
