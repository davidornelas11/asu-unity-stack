...
`;function tr({applyNowUrl:t,title:r,contents:a,photoGrid:o}){const s=he(r);return e.jsx("section",{className:"container","data-type":"text-photo-grid","data-testid":"intro-content",children:e.jsxs("div",{className:"row",children:[e.jsxs("div",{className:"col-sm-12 col-md-5",children:[e.jsx(s,{className:"mt-0",children:e.jsx("span",{className:`${z(r.cssClass)}`,children:r.text})}),e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]}),e.jsx("div",{className:"col-sm-12 col-md-7 d-none d-sm-none d-md-block",children:e.jsx(Za,{className:"row",children:o.images.map((i,n)=>e.jsx("div",{className:"photo-item col-sm-12 col-md-6 col-lg-6",children:e.jsx("img",{className:`mg-fluid ${z(i.cssClass)}`,src:i.url,alt:i.altText,style:{maxWidth:"100%"}})},`img-${n+1}`))})})]})})}function ar({applyNowUrl:t,title:r,contents:a,image:o,video:s}){const i=he(r);return e.jsx(er,{className:"container","data-type":"text-media","data-testid":"intro-content",children:e.jsxs("div",{className:"row gy-3",children:[e.jsxs("div",{className:"col-sm-12 col-md-5",children:[e.jsx(i,{className:"mt-0",children:e.jsx("span",{className:`${z(r.cssClass)}`,children:r.text})}),e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]}),e.jsxs("div",{className:"col-sm-12 col-md-7 mt-2 mt-sm-0",children:[s&&e.jsx(xa,{type:s.type,url:s.url,vttUrl:s.vttUrl,title:s.title,className:"mt-0"}),o&&e.jsx("div",{className:"uds-img",children:e.jsx("img",{src:o.url,className:"img-fluid",alt:o.altText})})]})]})})}function rr({applyNowUrl:t,title:r,contents:a,image:o}){return e.jsx("section",{className:"container","data-type":"text-image-overlay","data-testid":"intro-content",children:e.jsx("div",{className:"row",children:e.jsx("div",{className:"col-md-12",children:e.jsx(ya,{title:r.text,contents:a,image:o,contentDirection:"right",contentChildren:e.jsx("div",{className:"mt-2",children:e.jsx(H,{href:t})})})})})})}const sr=({applyNowUrl:t,title:r,contents:a})=>{const o=he(r);return e.jsx("section",{className:"container","data-type":"text","data-testid":"intro-content",children:e.jsxs("div",{className:"row",children:[e.jsx("div",{className:"col-sm-12 col-md-5",children:e.jsx(o,{className:"mt-0",children:e.jsx("span",{className:`${z(r.cssClass)}`,children:r.text})})}),e.jsxs("div",{className:"col-sm-12 col-md-7",children:[e.jsx(fe,{contents:a}),e.jsx(H,{href:t})]})]})})},be=({applyNowUrl:t,type:r,title:a,contents:o,image:s,video:i,photoGrid:n})=>({text:()=>sr({applyNowUrl:t,title:a,contents:o}),"text-media":()=>ar({applyNowUrl:t,title:a,contents:o,image:s,video:i}),"text-image-overlay":()=>rr({applyNowUrl:t,title:a,contents:o,image:s}),"text-photo-grid":()=>tr({applyNowUrl:t,title:a,contents:o,image:s,photoGrid:n}),undefined:()=>(console.error(`the type '${r}' is not supported by the 'IntroContent' component.`),null)})[r]();be.propTypes={applyNowUrl:d.string,type:d.oneOf(["text","text-media","text-image-overlay","text-photo-grid"]).isRequired,video:d.shape({...ma}),image:d.shape({...ua}),header:Te,title:d.shape({...ga,component:d.oneOf(ha)}),contents:d.arrayOf(Te),photoGrid:d.shape({images:d.arrayOf(fa)})};const Y={programs:d.arrayOf(d.object),totalRows:d.number,loading:d.bool,actionUrls:d.shape({applyNowUrl:d.string,majorInfoUrl:d.string,majorInfoOnlineUrl:d.string}),degreesPerPage:d.number},or=L.div`
  & {
    ul {
      margin-top: 1.5rem;
      margin-bottom: 0;
...
`,we=({appPathFolder:t,actionUrls:r,hasSearchBar:a=!0,hasFilters:o=!0,hero:s,introContent:i,programList:n,degreesPerPage:p})=>{var Ae;const[{data:c,loading:m,error:h},b]=Na(),[l,y]=x.useState(!1),[f,v]=x.useState([]),[S,u]=x.useState([]),[g,q]=x.useState(""),E=(Ae=n.settings)==null?void 0:Ae.defaultView,Xt=[pe,zt].includes(E)?E:pe,[Yt,br]=x.useState(Xt),te=Aa(n.dataSource,Ma),{defaultState:Qt}=x.useContext(J),{listingPageDefault:Pe}=Qt,{collegeAcadOrg:Ce,departmentCode:Le,showInactivePrograms:Zt,blacklistAcadPlans:Fe,program:qe,cert:ea}=n.dataSource,[Ie,ae]=x.useState({...R}),[G,Ne]=x.useState({...R});Ka({dataSource:n.dataSource,tableView:f,programs:c,stateFilters:Ie}),x.useEffect(()=>{typeof window<"u"&&Ta({packageName:"app-degree-pages",component:"ListingPage",type:"NA",configuration:{programList:n,degreesPerPage:p}})},[]),x.useEffect(()=>{b(te)},[te]),x.useEffect(()=>{let j=za(c||[]);j=De({programs:j,filters:{collegeAcadOrg:Ce,departmentCode:Le,blacklistAcadPlans:Fe,program:qe,showCerts:ea}}),u(j),v(j)},[c,p]);const re=async j=>{const{acceleratedConcurrent:se,locations:V,asuLocals:oe,keyword:ne}=j;y(!0),b(te);const na=De({programs:S,filters:{collegeAcadOrg:Ce,departmentCode:Le,acceleratedConcurrent:se,locations:oe.length>0?V.concat($a):V,keyword:ne,showInactivePrograms:Zt??!1,blacklistAcadPlans:Fe,program:qe}});ae({...j}),Ne({...j}),v(na),y(!1)},ta=async()=>{const j={...G,keyword:g};re(j)},aa=j=>{m||l||re(j)},ra=async j=>{ae(j)},sa=()=>{ae(R),Ne(R),v(S),q("")},oa=(j,{value:se})=>{const V=j==="acceleratedConcurrent"?_a:G[j].filter(ne=>ne.value!==se),oe={...G,[j]:V};re(oe)};return e.jsxs(e.Fragment,{children:[e.jsx(Ua,{}),e.jsx(xr,{}),h&&e.jsx(Da,{message:ka}),s!=null&&s.hide?null:e.jsx("section",{"data-testid":"hero",children:e.jsx(Kt,{image:(s==null?void 0:s.image)||Pe.hero.image,title:{text:Ba(n.dataSource),highlightColor:"gold",...s==null?void 0:s.title,maxWidth:"100%"},contents:s==null?void 0:s.contents})}),e.jsxs(fr,{"data-is-loading":m,className:"main-section dg-margin-top",children:[(i==null?void 0:i.breadcrumbs)&&e.jsx("div",{className:"container mt-4 mb-0",children:e.jsx(Oa,{breadcrumbs:i.breadcrumbs,section:s?s.title.text:""})}),i?e.jsx(be,{applyNowUrl:(r==null?void 0:r.applyNowUrl)||Pe.actionUrls.applyNowUrl,type:i.type,header:i.header,title:i.title,contents:i.contents,image:i.image,video:i.video,photoGrid:i.photoGrid}):null,a||o?e.jsxs("section",{className:"no-space",children:[e.jsx(Jt,{}),a?e.jsx(Se,{value:g,onChange:q,onSearch:ta}):null,o?e.jsx(xe,{value:Ie,onChange:ra,onApply:aa,onClean:sa}):null,e.jsx(yr,{})]}):null,e.jsx("section",{className:"container",children:e.jsx("div",{className:"d-flex justify-content-between filter-switch-container",children:o?e.jsx(ye,{value:G,onRemove:oa}):null})}),m||l?e.jsx(Ra,{}):e.jsx(ve,{dataViewComponent:Yt,loading:m||l,programs:f,actionUrls:r,degreesPerPage:p})]})]})};we.propTypes={appPathFolder:d.string,actionUrls:d.shape({applyNowUrl:d.string}),hasSearchBar:d.bool,hasFilters:d.bool,hero:d.shape(Kt.propTypes),introContent:d.shape(be.propTypes),programList:d.shape({dataSource:La,settings:Fa}),degreesPerPage:d.number};const ee=t=>e.jsx(Ia,{listPageProps:t,children:e.jsx(we,{...t})});ee.propTypes=we.propTypes;ee.__docgenInfo={description:`@param {ListingPageProps} props
@returns {JSX.Element}`,methods:[],displayName:"AppComponent",props:{appPathFolder:{description:"",type:{name:"string"},required:!1},actionUrls:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1}}},required:!1},hasSearchBar:{description:"",type:{name:"bool"},required:!1},hasFilters:{description:"",type:{name:"bool"},required:!1},hero:{description:"",type:{name:"shape",value:"Hero.propTypes",computed:!0},required:!1},introContent:{description:"",type:{name:"shape",value:{applyNowUrl:{name:"string",required:!1},type:{name:"enum",value:[{value:'"text"',computed:!1},{value:'"text-media"',computed:!1},{value:'"text-image-overlay"',computed:!1},{value:'"text-photo-grid"',computed:!1}],required:!0},video:{name:"shape",value:{},required:!1},image:{name:"shape",value:{},required:!1},header:{name:"custom",raw:"contentPropShape",required:!1},title:{name:"shape",value:{component:{name:"enum",value:[{value:'"h1"',computed:!1},{value:'"h2"',computed:!1},{value:'"h3"',computed:!1},{value:'"h4"',computed:!1},{value:'"h5"',computed:!1},{value:'"h6"',computed:!1}],required:!1}},required:!1},contents:{name:"arrayOf",value:{name:"custom",raw:"contentPropShape"},required:!1},photoGrid:{name:"shape",value:{images:{name:"arrayOf",value:{name:"custom",raw:"imagePropShape"},required:!1}},required:!1}}},required:!1},programList:{description:"",type:{name:"shape",value:{dataSource:{name:"custom",raw:"dataSourcePropShape",required:!1},settings:{name:"custom",raw:"columSettingsPropShape",required:!1}}},required:!1},degreesPerPage:{description:"",type:{name:"number"},required:!1}}};const Pr={component:ee,title:"Program Listing Page",parameters:{docs:{description:{component:"@typedef {import('../../core/types/listing-page-types').ListingPageProps } AppProps"}}}},w=({appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasFilters:i,hasSearchBar:n,...p})=>e.jsx(ee,{appPathFolder:t,actionUrls:r,hero:a,introContent:o,programList:s,hasSearchBar:n,hasFilters:i,...p}),_={applyNowUrl:"https://admission.asu.edu/apply",majorInfoUrl:`${me()}?path=/story/program-detail-page--default&acadPlan={ACAD_PLAN_CODE}`},$={program:"undergrad"},P={appPathFolder:".",actionUrls:_,hero:null,introContent:{breadcrumbs:[{text:"Academic programs",url:"#"},{text:"Undergraduate degrees",url:`${me()}?path=/story/program-listing-page--default`},{text:"Degree title",url:`${me()}?path=/story/program-detail-page--with-content`,isActive:!0}],type:"text",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<p>Lorem, <strong>ipsum</strong> dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
    ...
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}],photoGrid:{images:[{url:"examples/assets/img/demo-phot-1.jpeg"},{url:"examples/assets/img/demo-phot-2.jpeg"},{url:"examples/assets/img/demo-phot-3.jpeg"}]}},hasFilters:!1,hasSearchBar:!1,programList:{dataSource:$}};const C=w.bind({});C.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",size:"medium"},title:{text:"Area of study degrees",highlightColor:"gold"}},introContent:{type:"text-media",title:{text:"This is introductory marketing copy. Lorem ipsum dolor sit amet"},contents:[{text:`<b>Lorem</b>, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?
     Lorem, ipsum dolor sit amet consectetur adipisicing elit. Molestias aut, repellat ipsum facere voluptate dicta obcaecati deserunt nobis suscipit eaque?`}],image:{url:"https://source.unsplash.com/random/800x400?a=1"}},programList:{dataSource:$}};const I=w.bind({});I.args={...C.args};I.args.introContent={...C.args.introContent,image:void 0,video:{url:"/examples/assets/video/stock-video-person-drawing.mp4",title:"",vttUrl:""}};const N=w.bind({});N.args={...C.args};N.args.introContent={...C.args.introContent,image:void 0,video:{type:"youtube",url:"https://www.youtube.com/embed/YW2p0ctzK9c"}};const O=w.bind({});O.args={actionUrls:_,hero:{image:{url:"examples/assets/img/ds_header_undergrad.jpg",size:"medium"},title:{text:"[Subdomain] degrees in [area of study]",highlightColor:"gold"}},introContent:{type:"text-image-overlay",header:{text:"Intro Content Image Overlay"},title:{text:"This is the contents that goes in the box"},contents:[{text:`<b>Instagram</b> tour operator travel sailing flying package.
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Ve=(Ge=M.parameters)==null?void 0:Ge.docs)==null?void 0:Ve.source}}};var We,ze,Ke,He,Je;A.parameters={...A.parameters,docs:{...(We=A.parameters)==null?void 0:We.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Ke=(ze=A.parameters)==null?void 0:ze.docs)==null?void 0:Ke.source},description:{story:"@type {{ args: AppProps }}",...(Je=(He=A.parameters)==null?void 0:He.docs)==null?void 0:Je.description}}};var Xe,Ye,Qe,Ze,et;T.parameters={...T.parameters,docs:{...(Xe=T.parameters)==null?void 0:Xe.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Qe=(Ye=T.parameters)==null?void 0:Ye.docs)==null?void 0:Qe.source},description:{story:"@type {{ args: AppProps }}",...(et=(Ze=T.parameters)==null?void 0:Ze.docs)==null?void 0:et.description}}};var tt,at,rt,st,ot;U.parameters={...U.parameters,docs:{...(tt=U.parameters)==null?void 0:tt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(wt=(St=C.parameters)==null?void 0:St.docs)==null?void 0:wt.source},description:{story:"@type {{ args: AppProps}}",...(Ct=(Pt=C.parameters)==null?void 0:Pt.docs)==null?void 0:Ct.description}}};var Lt,Ft,qt,It,Nt;I.parameters={...I.parameters,docs:{...(Lt=I.parameters)==null?void 0:Lt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(qt=(Ft=I.parameters)==null?void 0:Ft.docs)==null?void 0:qt.source},description:{story:"@type {{ args: AppProps}}",...(Nt=(It=I.parameters)==null?void 0:It.docs)==null?void 0:Nt.description}}};var At,Tt,Ut,Dt,kt;N.parameters={...N.parameters,docs:{...(At=N.parameters)==null?void 0:At.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
  ...
  hasSearchBar,
  ...rest
}) => <ListingPage appPathFolder={appPathFolder} actionUrls={actionUrls} hero={hero} introContent={introContent} programList={programList} hasSearchBar={hasSearchBar} hasFilters={hasFilters} {...rest} />`,...(Ut=(Tt=N.parameters)==null?void 0:Tt.docs)==null?void 0:Ut.source},description:{story:"@type {{ args: AppProps}}",...(kt=(Dt=N.parameters)==null?void 0:Dt.docs)==null?void 0:kt.description}}};var Bt,Ot,Rt,Mt,_t;O.parameters={...O.parameters,docs:{...(Bt=O.parameters)==null?void 0:Bt.docs,source:{originalSource:`({
  appPathFolder,
  actionUrls,
  hero,
  introContent,
