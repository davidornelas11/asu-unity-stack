import{D as Dt,q as S,j as e,p as h,t as q,P as n,s as N,Q as Ot,Z as Lt,g as ie,a as Fe,i as Pt,b as J,O as ae,e as At,f as le,c as Et,m as _t,v as Ft,d as Ut,h as Wt,k as I,l as X,n as ne,S as Gt,w as Nt,o as Bt,r as Vt,u as Ct,x as oe,y as Ht,A as $t,z as Jt,B as Ue,C as Xt,E as zt,F as Yt,G as Qt,T as Zt,H as Kt,I as ea,J as ta,K as aa,M as ra,L as na,N as oa,R as sa,U as ia,V as la,W as We}from"./index-BNbMXf1Z.js";import{r as R}from"./index-B2SEcK1p.js";import{g as pa}from"./_commonjsHelpers-B3tUAs5q.js";import"./index-D5FjP4YR.js";const Ge=a=>a.map(t=>({title:t.acadPlanDescription,url:t.academicOfficeUrl})).sort((t,r)=>t.title.localeCompare(r.title)),ca=a=>a==null?void 0:a.map(t=>({career:{text:t.alternateTitle,url:`${Dt}/career-details/${t.onetCode}`},growth:t.growth,medianSalary:t.salary.toLocaleString("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}),brightOutlook:!!t.brightOutlook,greenOccupation:!!t.green}));function ma(a,t){Promise.all(a).then(r=>{const i=r[0],o=r[1];t({accelerateData:i,concurrentData:o})}).catch(()=>{t({accelerateData:[],concurrentData:[]})})}const ua=S.section`
  position: relative;
